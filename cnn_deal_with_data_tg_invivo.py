...
trainTestVal_split("/dev/sda3/Huichen/2nd/val/drug_matrix/rat_invivo/pic_12","/dev/sda3/Huichen/2nd/val/label_rat_invivo.csv","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/save")
batchCsvToPicture("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/save",108)

batchCrop("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/save","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/crop",108,36)
batchResize("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/crop","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/resize/alexnet",108,227)
batchResize("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/crop","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/resize/resnet",108,224)
batchResize("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/crop","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/resize/googlenet",108,224)
batchResize("/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/crop","/dev/sda3/Huichen/2nd/val/rat_invivo/cnn/resize/googlenet",108,28)

#a=np.load("F:/Huichen_Wu/2nd/res/prop.npy")
#print(a)