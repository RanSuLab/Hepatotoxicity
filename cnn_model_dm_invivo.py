...
if __name__ == '__main__':
    ...
    batchTrain("./resnet", "./dm_invivo/cnn/res", 'resNet',0, 125)
    batchTrain("./googlenet", "./dm_invivo/cnn/res", 'googlenet',0, 125)
    batchTrain("./lenet", "./dm_invivo/cnn/res", 'lenet',0, 125)
	batchTrain("./alexnet", "./dm_invivo/cnn/res", 'alexNet',0, 125)
