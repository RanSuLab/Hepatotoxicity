...
trainTestVal_split("./tg_tg_invitro/pic_8","./label_tg_rat_invitro.csv","./tg_rat_invitro/cnn/save")
batchCsvToPicture("./rat_invitro/cnn/save",108)

batchCrop("./tg_rat_invitro/cnn/save","./tg_rat_invitro/cnn/crop",108,36)
batchResize("./tg_rat_invitro/cnn/crop","./tg_rat_invitro/cnn/resize/alexnet",108,227)
batchResize("./tg_rat_invitro/cnn/crop","./tg_rat_invitro/cnn/resize/resnet",108,224)
batchResize("./tg_rat_invitro/cnn/crop","./tg_rat_invitro/cnn/resize/googlenet",108,224)
batchResize("./tg_rat_invitro/cnn/crop","./tg_rat_invitro/cnn/resize/lenet",108,28)
