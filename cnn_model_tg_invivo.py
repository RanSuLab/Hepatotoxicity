...
if __name__ == '__main__':
    ...
    batchTrain("./resnet", "./tg_invivo/cnn/res", 'resNet',0, 108£©
    batchTrain("./googlenet", "./tg_invivo/cnn/res", 'googlenet',0, 108)
    batchTrain("./lenet", "./tg_invivo/cnn/res", 'lenet',0, 108)
	batchTrain("./alexnet", "./tg_invivo/cnn/res", 'alexNet',0, 108)
